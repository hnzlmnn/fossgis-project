...
Temperature differences within urban areas are so-called \ldq{}Intra-Urban Heat Islands (IUHI)\rdq{}. %TODO: cite (Bruns & Simko, 2017)
These heat islands within the city have a negative effect, not only for people’s health, well-being and comfort – especially in regard to the vulnerable population – but also for infrastructure, urban ecosystems and the living environment. Moreover, increased heat stress has been found to be the source for higher energy demands (for cooling) and the degradation of air quality in urban areas. %TODO: cite (Mohajerani et al., 2017)
...
Fostering measures such as cool and reflective pavements, green spaces and air circulation systems
%TODO: cite (Mohajerani et al., 2017)
